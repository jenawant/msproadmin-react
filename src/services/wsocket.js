...
class Wsocket {
  ...
  onMessage(evt) {
    ...
    this.onEvent.hasOwnProperty(result.event) || tool.capsule('INFO', `The message event[${result.event}] is not bound...`, 'warning')
  }
  ...
  reconnect() {
    ...
    this.reconnectConfig.timer = setTimeout(_ => {
      ...
      tool.capsule('INFO', `Disconacted, retrying(${this.reconnectConfig.retry})...`, 'warning')
    }, reconnect.interval)
  }
